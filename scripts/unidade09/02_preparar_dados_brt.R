...
write_csv(
  treino,
  "dados/unidade09/processados/treino_brt_dinizia.csv"
)

write_csv(
  teste,
  "dados/unidade09/processados/teste_brt_dinizia.csv"
)

write_csv(
  dados_modelo,
  "dados/unidade09/processados/dados_brt_dinizia.csv"
)

write_csv(
  dados_modelo,
  "dados/unidade09/processados/dados_presenca_background_bioma_brt_dinizia.csv"
)

variaveis_brt <- tibble(
...
write_csv(
  variaveis_brt,
  "resultados/unidade09/variaveis_brt.csv"
)

write_csv(
  variaveis_brt,
  "tabelas/unidade09/variaveis_usadas_brt.csv"
)
...
write_csv(
  resumo,
  "tabelas/unidade09/resumo_dados_brt.csv"
)
...
message("Dados presença-background preparados para BRT no bioma Amazônia.")
