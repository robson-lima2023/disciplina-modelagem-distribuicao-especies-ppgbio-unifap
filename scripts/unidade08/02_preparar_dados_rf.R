...
write_csv(
  treino,
  "dados/unidade08/processados/treino_rf_dinizia.csv"
)

write_csv(
  teste,
  "dados/unidade08/processados/teste_rf_dinizia.csv"
)

write_csv(
  dados_modelo,
  "dados/unidade08/processados/dados_rf_dinizia.csv"
)

write_csv(
  dados_modelo,
  "dados/unidade08/processados/dados_presenca_background_bioma_rf_dinizia.csv"
)
...
write_csv(
  metadados,
  "resultados/unidade08/variaveis_rf.csv"
)

write_csv(
  metadados,
  "tabelas/unidade08/variaveis_usadas_rf.csv"
)
...
write_csv(
  resumo,
  "tabelas/unidade08/resumo_dados_rf.csv"
)
...
message("Dados presença-background preparados para Random Forest no bioma Amazônia.")
