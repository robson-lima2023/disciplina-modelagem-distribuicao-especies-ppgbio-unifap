...
# Script 02: Preparar dados presença-background para GAM
# ============================================================
...
write_csv(
  treino_z,
  "dados/unidade07/processados/treino_gam_dinizia.csv"
)

write_csv(
  teste_z,
  "dados/unidade07/processados/teste_gam_dinizia.csv"
)

write_csv(
  dados_z,
  "dados/unidade07/processados/dados_gam_dinizia_padronizados.csv"
)

write_csv(
  dados_modelo,
  "dados/unidade07/processados/dados_presenca_background_bioma_gam_dinizia.csv"
)
...
write_csv(
  resumo,
  "tabelas/unidade07/resumo_dados_gam.csv"
)
...
write_csv(
  variaveis_usadas,
  "tabelas/unidade07/variaveis_usadas_gam.csv"
)
...
message("Dados presença-background preparados para GAM no bioma Amazônia.")
